 ...
 *       &lt;sequence&gt;
 *         &lt;element name="WvrInd" type="{urn:kdpw:xsd:trar.ins.001.04}ReportingWaiverType1Code" maxOccurs="6" minOccurs="0"/&gt;
 *         &lt;element name="ShrtSellgInd" type="{urn:kdpw:xsd:trar.ins.001.04}Side5Code" minOccurs="0"/&gt;
 *         &lt;element name="OTCPstTradInd" type="{urn:kdpw:xsd:trar.ins.001.04}ReportingWaiverType3Code" maxOccurs="13" minOccurs="0"/&gt;
 *         &lt;element name="RskRdcgTx" type="{urn:kdpw:xsd:trar.ins.001.04}YesNoIndicator" minOccurs="0"/&gt;
 *         &lt;element name="SctiesFincgTxInd" type="{urn:kdpw:xsd:trar.ins.001.04}YesNoIndicator"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
