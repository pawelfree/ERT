 ...
 *       &lt;sequence&gt;
 *         &lt;element name="DlvryIntrvl" type="{urn:kdpw:xsd:trar.ins.001.04}ESMANormalisedTime" minOccurs="0"/&gt;
 *         &lt;element name="DlvryPrd" type="{urn:kdpw:xsd:trar.ins.001.04}Period10__1" minOccurs="0"/&gt;
 *         &lt;element name="Drtn" type="{urn:kdpw:xsd:trar.ins.001.04}DurationType1Code_TR" minOccurs="0"/&gt;
 *         &lt;element name="WkDay" type="{urn:kdpw:xsd:trar.ins.001.04}WeekDay1Code_TR" minOccurs="0"/&gt;
 *         &lt;element name="DlvryCpcty" type="{urn:kdpw:xsd:trar.ins.001.04}Amount20_SimpleType_Negative" minOccurs="0"/&gt;
 *         &lt;element name="QtyUnit" type="{urn:kdpw:xsd:trar.ins.001.04}EnergyQuantityUnit_TR" minOccurs="0"/&gt;
 *         &lt;element name="PricTmIntrvlQty" type="{urn:kdpw:xsd:trar.ins.001.04}Amount20_SimpleType_Negative" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
