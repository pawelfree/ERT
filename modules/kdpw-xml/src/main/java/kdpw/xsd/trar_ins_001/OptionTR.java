 ...
 *         &lt;element name="StrkPric" type="{urn:kdpw:xsd:trar.ins.001.03}SecuritiesTransactionPrice7Choice_TR"/&gt;
 *         &lt;element name="StrkPricNttn" type="{urn:kdpw:xsd:trar.ins.001.03}Max1Text"/&gt;
...
public class OptionTR {
    ...
    @XmlElement(name = "StrkPricNttn", required = true)
