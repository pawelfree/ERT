 ...
 *         &lt;element name="CtrPtySd" type="{urn:kdpw:xsd:trar.ins.001.03}OptionParty1Code"/&gt;
 *         &lt;element name="Sctr" type="{urn:kdpw:xsd:trar.ins.001.03}Max2Text" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="Ntr" type="{urn:kdpw:xsd:trar.ins.001.03}CounterpartyTradeNature_TR"/&gt;
 *         &lt;element name="Brkr" type="{urn:kdpw:xsd:trar.ins.001.03}LEIIdentifier" minOccurs="0"/&gt;
 *         &lt;element name="ClrMmb" type="{urn:kdpw:xsd:trar.ins.001.03}LEIIdentifier" minOccurs="0"/&gt;
 *         &lt;element name="Bnfcry" type="{urn:kdpw:xsd:trar.ins.001.03}OrganisationIdentification3Choice__1"/&gt;
 *         &lt;element name="TradgCpcty" type="{urn:kdpw:xsd:trar.ins.001.03}TradingCapacity7Code" minOccurs="0"/&gt;
 *         &lt;element name="CmmrclActvty" type="{urn:kdpw:xsd:trar.ins.001.03}YesNoIndicator" minOccurs="0"/&gt;
 *         &lt;element name="ClrTrshld" type="{urn:kdpw:xsd:trar.ins.001.03}YesNoIndicator" minOccurs="0"/&gt;
 *         &lt;element name="OthrCtrPty" type="{urn:kdpw:xsd:trar.ins.001.03}CounterpartyOther_TR_R"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
