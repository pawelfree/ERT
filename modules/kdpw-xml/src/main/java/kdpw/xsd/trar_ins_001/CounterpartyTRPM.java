 ...
 * 
 * <p>Java class for Counterparty_TR_P_M complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="Counterparty_TR_P_M"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="RptgCtrPtyId" type="{urn:kdpw:xsd:trar.ins.001.04}LEIIdentifier"/&gt;
 *         &lt;element name="CtrPtySd" type="{urn:kdpw:xsd:trar.ins.001.04}OptionParty1Code"/&gt;
 *         &lt;element name="Sctr" type="{urn:kdpw:xsd:trar.ins.001.04}Max2Text" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="Ntr" type="{urn:kdpw:xsd:trar.ins.001.04}CounterpartyTradeNature_TR"/&gt;
 *         &lt;element name="Brkr" type="{urn:kdpw:xsd:trar.ins.001.04}LEIIdentifier" minOccurs="0"/&gt;
 *         &lt;element name="ClrMmb" type="{urn:kdpw:xsd:trar.ins.001.04}LEIIdentifier" minOccurs="0"/&gt;
 *         &lt;element name="Bnfcry" type="{urn:kdpw:xsd:trar.ins.001.04}OrganisationIdentification3Choice__1"/&gt;
 *         &lt;element name="TradgCpcty" type="{urn:kdpw:xsd:trar.ins.001.04}TradingCapacity7Code" minOccurs="0"/&gt;
 *         &lt;element name="CmmrclActvty" type="{urn:kdpw:xsd:trar.ins.001.04}YesNoIndicator" minOccurs="0"/&gt;
 *         &lt;element name="ClrTrshld" type="{urn:kdpw:xsd:trar.ins.001.04}YesNoIndicator" minOccurs="0"/&gt;
 *         &lt;element name="OthrCtrPty" type="{urn:kdpw:xsd:trar.ins.001.04}CounterpartyOther_TR_M"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "Counterparty_TR_P_M", propOrder = {
    "rptgCtrPtyId",
    "ctrPtySd",
    "sctr",
    "ntr",
...
public class CounterpartyTRPM {
    ...
    protected CounterpartyOtherTRM othrCtrPty;
     ...
     * @return
     *     possible object is
     *     {@link CounterpartyOtherTRM }
     *     
     */
    public CounterpartyOtherTRM getOthrCtrPty() {
        return othrCtrPty;
    }
     ...
     *     
     */
    public void setOthrCtrPty(CounterpartyOtherTRM value) {
