 ...
 *           &lt;element name="AltrntvInstrmId" type="{urn:kdpw:xsd:trar.ins.001.04}ESMAMax48AlphaNumericAdditionalCharactersAII"/&gt;
 *           &lt;element name="UnqPdctIdr" type="{urn:kdpw:xsd:trar.ins.001.04}ESMAMax52AlphaNumeric"/&gt;
 *           &lt;element name="BsktCnsttnts" type="{urn:kdpw:xsd:trar.ins.001.04}SecurityIdentification18Choice__1" maxOccurs="unbounded"/&gt;
 *           &lt;element name="Indx" type="{urn:kdpw:xsd:trar.ins.001.04}SecurityIdentification20Choice"/&gt;
 *           &lt;element name="IdNotAvlbl" type="{urn:kdpw:xsd:trar.ins.001.04}IdentificationNotAvailable"/&gt;
 *         &lt;/choice&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
