 ...
 *       &lt;sequence&gt;
 *         &lt;element name="TradgCpcty" type="{urn:kdpw:xsd:trar.ins.001.04}RegulatoryTradingCapacity1Code"/&gt;
 *         &lt;element name="DerivNtnlChng" type="{urn:kdpw:xsd:trar.ins.001.04}VariationType1Code" minOccurs="0"/&gt;
 *         &lt;element name="CtryOfBrnch" type="{urn:kdpw:xsd:trar.ins.001.04}CountryCode" minOccurs="0"/&gt;
 *         &lt;element name="UpFrntPmtCcy" type="{urn:kdpw:xsd:trar.ins.001.04}ActiveCurrencyCode" minOccurs="0"/&gt;
 *         &lt;element name="TradPlcMtchgId" type="{urn:kdpw:xsd:trar.ins.001.04}ESMA_AlphaNumericMax52_Pattern" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
