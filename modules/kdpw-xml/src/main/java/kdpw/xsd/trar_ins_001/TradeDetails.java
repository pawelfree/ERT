 ...
 *       &lt;sequence&gt;
 *         &lt;element name="TradId" type="{urn:kdpw:xsd:trar.ins.001.02}TradeIdentification" minOccurs="0"/&gt;
 *         &lt;element name="CntrctTp" type="{urn:kdpw:xsd:trar.ins.001.02}ContractType" minOccurs="0"/&gt;
 *         &lt;element name="TradAddtlInf" type="{urn:kdpw:xsd:trar.ins.001.02}TradeAdditionalInformation" minOccurs="0"/&gt;
 *         &lt;element name="RskMtgtn" type="{urn:kdpw:xsd:trar.ins.001.02}RiskMitigation" minOccurs="0"/&gt;
 *         &lt;element name="ClrgInf" type="{urn:kdpw:xsd:trar.ins.001.02}ClearingInformation" minOccurs="0"/&gt;
 *         &lt;element name="IRTrad" type="{urn:kdpw:xsd:trar.ins.001.02}InterestRateTrade" minOccurs="0"/&gt;
 *         &lt;element name="FXTrad" type="{urn:kdpw:xsd:trar.ins.001.02}FXTrade" minOccurs="0"/&gt;
 *         &lt;element name="CmmdtyTrad" type="{urn:kdpw:xsd:trar.ins.001.02}CommodityTrade" minOccurs="0"/&gt;
 *         &lt;element name="OptnTrad" type="{urn:kdpw:xsd:trar.ins.001.02}OptionTrade" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
