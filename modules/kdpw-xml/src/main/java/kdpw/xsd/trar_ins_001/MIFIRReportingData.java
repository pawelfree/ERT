 ...
 *         &lt;element name="InvstmtPtyInd" type="{urn:kdpw:xsd:trar.ins.001.04}YesNoIndicator"/&gt;
 *         &lt;element name="BuyrAddtlDtls" type="{urn:kdpw:xsd:trar.ins.001.04}PartyIdentification_EMIR" minOccurs="0"/&gt;
 *         &lt;element name="SellrAddtlDtls" type="{urn:kdpw:xsd:trar.ins.001.04}PartyIdentification_EMIR" minOccurs="0"/&gt;
 *         &lt;element name="OrdrTrnsmssn" type="{urn:kdpw:xsd:trar.ins.001.04}SecuritiesTransactionTransmission2"/&gt;
 *         &lt;element name="Tx" type="{urn:kdpw:xsd:trar.ins.001.04}MIFIRTransactionData"/&gt;
 *         &lt;element name="FinInstrm" type="{urn:kdpw:xsd:trar.ins.001.04}MIFIRInstrumentData" minOccurs="0"/&gt;
 *         &lt;element name="InvstmtDcsnPrsn" type="{urn:kdpw:xsd:trar.ins.001.04}InvestmentParty1Choice__1" minOccurs="0"/&gt;
 *         &lt;element name="ExctgPrsn" type="{urn:kdpw:xsd:trar.ins.001.04}ExecutingParty1Choice__1" minOccurs="0"/&gt;
 *         &lt;element name="AddtlAttrbts" type="{urn:kdpw:xsd:trar.ins.001.04}SecuritiesTransactionIndicator2__1"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
