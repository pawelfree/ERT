 ...
 *       &lt;sequence&gt;
 *         &lt;element name="UnqTradIdr" type="{urn:kdpw:xsd:trar.ins.001.03}KDPWMax52AlphaNumericAdditionalCharacters" minOccurs="0"/&gt;
 *         &lt;element name="EligDt" type="{urn:kdpw:xsd:trar.ins.001.03}ISODate"/&gt;
 *         &lt;element name="Collstn" type="{urn:kdpw:xsd:trar.ins.001.03}CollateralisationType1Code"/&gt;
 *         &lt;element name="PrtflColl" type="{urn:kdpw:xsd:trar.ins.001.03}YesNoIndicator" minOccurs="0"/&gt;
 *         &lt;element name="Prtfl" type="{urn:kdpw:xsd:trar.ins.001.03}KDPWMax52AlphaNumericAdditionalCharacters" minOccurs="0"/&gt;
 *         &lt;element name="InitlMrgnPstd" type="{urn:kdpw:xsd:trar.ins.001.03}ActiveCurrencyAnd20Amount" minOccurs="0"/&gt;
 *         &lt;element name="VartnMrgnPstd" type="{urn:kdpw:xsd:trar.ins.001.03}ActiveCurrencyAnd20Amount" minOccurs="0"/&gt;
 *         &lt;element name="InitlMrgnRcvd" type="{urn:kdpw:xsd:trar.ins.001.03}ActiveCurrencyAnd20Amount" minOccurs="0"/&gt;
 *         &lt;element name="VartnMrgnRcvd" type="{urn:kdpw:xsd:trar.ins.001.03}ActiveCurrencyAnd20Amount" minOccurs="0"/&gt;
 *         &lt;element name="XcssCollPstd" type="{urn:kdpw:xsd:trar.ins.001.03}ActiveCurrencyAnd20Amount" minOccurs="0"/&gt;
 *         &lt;element name="XcssCollRcvd" type="{urn:kdpw:xsd:trar.ins.001.03}ActiveCurrencyAnd20Amount" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
