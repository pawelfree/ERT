 ...
 *       &lt;sequence&gt;
 *         &lt;element name="RptgCtrPtyId" type="{urn:kdpw:xsd:trar.sts.001.04}Max20Text"/&gt;
 *         &lt;element name="CtrPtySd" type="{urn:kdpw:xsd:trar.sts.001.04}OptionParty1Code"/&gt;
 *         &lt;element name="Sctr" type="{urn:kdpw:xsd:trar.sts.001.04}Max53Text" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="Ntr" type="{urn:kdpw:xsd:trar.sts.001.04}CounterpartyTradeNature_TR"/&gt;
 *         &lt;element name="Brkr" type="{urn:kdpw:xsd:trar.sts.001.04}LEIIdentifier" minOccurs="0"/&gt;
 *         &lt;element name="ClrMmb" type="{urn:kdpw:xsd:trar.sts.001.04}LEIIdentifier" minOccurs="0"/&gt;
 *         &lt;element name="Bnfcry" type="{urn:kdpw:xsd:trar.sts.001.04}OrganisationIdentification3Choice__1"/&gt;
 *         &lt;element name="TradgCpcty" type="{urn:kdpw:xsd:trar.sts.001.04}TradingCapacity7Code" minOccurs="0"/&gt;
 *         &lt;element name="CmmrclActvty" type="{urn:kdpw:xsd:trar.sts.001.04}YesNoIndicator" minOccurs="0"/&gt;
 *         &lt;element name="ClrTrshld" type="{urn:kdpw:xsd:trar.sts.001.04}YesNoIndicator" minOccurs="0"/&gt;
 *         &lt;element name="OthrCtrPty" type="{urn:kdpw:xsd:trar.sts.001.04}CounterpartyOther_TR_N"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
