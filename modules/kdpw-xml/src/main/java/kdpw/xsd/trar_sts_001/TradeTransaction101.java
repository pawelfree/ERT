 ...
 *       &lt;sequence&gt;
 *         &lt;element name="UnqTradIdr" type="{urn:kdpw:xsd:trar.sts.001.04}Max52Text"/&gt;
 *         &lt;element name="RptTrckgNb" type="{urn:kdpw:xsd:trar.sts.001.04}Max52Text" minOccurs="0"/&gt;
 *         &lt;element name="CmplxTradId" type="{urn:kdpw:xsd:trar.sts.001.04}ESMAMax35AlphaNumeric" minOccurs="0"/&gt;
 *         &lt;element name="TradgVn" type="{urn:kdpw:xsd:trar.sts.001.04}MICIdentifier"/&gt;
 *         &lt;element name="Cmprssn" type="{urn:kdpw:xsd:trar.sts.001.04}YesNoIndicator"/&gt;
 *         &lt;element name="Pric" type="{urn:kdpw:xsd:trar.sts.001.04}SecuritiesTransactionPrice7Choice_TR" minOccurs="0"/&gt;
 *         &lt;element name="NtnlAmt" type="{urn:kdpw:xsd:trar.sts.001.04}Amount20_SimpleType_Negative"/&gt;
 *         &lt;element name="PricMltplr" type="{urn:kdpw:xsd:trar.sts.001.04}Amount20_SimpleType"/&gt;
 *         &lt;element name="Qty" type="{urn:kdpw:xsd:trar.sts.001.04}Amount20_SimpleType"/&gt;
 *         &lt;element name="UpFrntPmt" type="{urn:kdpw:xsd:trar.sts.001.04}Amount20_SimpleType_Negative" minOccurs="0"/&gt;
 *         &lt;element name="DlvryTp" type="{urn:kdpw:xsd:trar.sts.001.04}PhysicalTransferType4Code"/&gt;
 *         &lt;element name="ExctnDtTm" type="{urn:kdpw:xsd:trar.sts.001.04}ISONormalisedDateTime" minOccurs="0"/&gt;
 *         &lt;element name="FctvDt" type="{urn:kdpw:xsd:trar.sts.001.04}ISODate" minOccurs="0"/&gt;
 *         &lt;element name="MtrtyDt" type="{urn:kdpw:xsd:trar.sts.001.04}ISODate" minOccurs="0"/&gt;
 *         &lt;element name="TermntnDt" type="{urn:kdpw:xsd:trar.sts.001.04}ISODate" minOccurs="0"/&gt;
 *         &lt;element name="SttlmDt" type="{urn:kdpw:xsd:trar.sts.001.04}ISODate" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="MstrAgrmt" type="{urn:kdpw:xsd:trar.sts.001.04}MasterAgreement_TR" minOccurs="0"/&gt;
 *         &lt;element name="TradConf" type="{urn:kdpw:xsd:trar.sts.001.04}TradeConfirmation_TR" minOccurs="0"/&gt;
 *         &lt;element name="TradClr" type="{urn:kdpw:xsd:trar.sts.001.04}TradeClearing_TR"/&gt;
 *         &lt;element name="IntrstRate" type="{urn:kdpw:xsd:trar.sts.001.04}InterestRateLegs4__1" minOccurs="0"/&gt;
 *         &lt;element name="Ccy" type="{urn:kdpw:xsd:trar.sts.001.04}CurrencyExchange10__1" minOccurs="0"/&gt;
 *         &lt;element name="Cmmdty" type="{urn:kdpw:xsd:trar.sts.001.04}CommodityTrade" minOccurs="0"/&gt;
 *         &lt;element name="Optn" type="{urn:kdpw:xsd:trar.sts.001.04}Option_TR" minOccurs="0"/&gt;
 *         &lt;element name="Cdt" type="{urn:kdpw:xsd:trar.sts.001.04}CreditDerivative_TR" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
