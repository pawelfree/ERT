 ...
 *       &lt;sequence&gt;
 *         &lt;element name="Collstn" type="{urn:kdpw:xsd:trar.sts.001.04}CollateralisationType1Code"/&gt;
 *         &lt;element name="PrtflColl" type="{urn:kdpw:xsd:trar.sts.001.04}YesNoIndicator" minOccurs="0"/&gt;
 *         &lt;element name="Prtfl" type="{urn:kdpw:xsd:trar.sts.001.04}KDPWMax52AlphaNumericAdditionalCharacters" minOccurs="0"/&gt;
 *         &lt;element name="InitlMrgnPstd" type="{urn:kdpw:xsd:trar.sts.001.04}ActiveCurrencyAnd20Amount" minOccurs="0"/&gt;
 *         &lt;element name="VartnMrgnPstd" type="{urn:kdpw:xsd:trar.sts.001.04}ActiveCurrencyAnd20Amount" minOccurs="0"/&gt;
 *         &lt;element name="InitlMrgnRcvd" type="{urn:kdpw:xsd:trar.sts.001.04}ActiveCurrencyAnd20Amount" minOccurs="0"/&gt;
 *         &lt;element name="VartnMrgnRcvd" type="{urn:kdpw:xsd:trar.sts.001.04}ActiveCurrencyAnd20Amount" minOccurs="0"/&gt;
 *         &lt;element name="XcssCollPstd" type="{urn:kdpw:xsd:trar.sts.001.04}ActiveCurrencyAnd20Amount" minOccurs="0"/&gt;
 *         &lt;element name="XcssCollRcvd" type="{urn:kdpw:xsd:trar.sts.001.04}ActiveCurrencyAnd20Amount" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
