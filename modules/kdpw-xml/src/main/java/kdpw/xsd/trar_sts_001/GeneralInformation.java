 ...
 *       &lt;sequence&gt;
 *         &lt;element name="RptgNtty" type="{urn:kdpw:xsd:trar.sts.001.04}LEIIdentifier" minOccurs="0"/&gt;
 *         &lt;element name="SndrMsgRef" type="{urn:kdpw:xsd:trar.sts.001.04}Max16Text"/&gt;
 *         &lt;element name="ActnTp" type="{urn:kdpw:xsd:trar.sts.001.04}Max1Text"/&gt;
 *         &lt;element name="Lvl" type="{urn:kdpw:xsd:trar.sts.001.04}Max1Text"/&gt;
 *         &lt;element name="RepTmStmp" type="{urn:kdpw:xsd:trar.sts.001.04}ISODateTime"/&gt;
 *         &lt;element name="Lnk" type="{urn:kdpw:xsd:trar.sts.001.04}Linkages"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
