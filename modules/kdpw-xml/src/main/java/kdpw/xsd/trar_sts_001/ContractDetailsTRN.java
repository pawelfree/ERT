 ...
 *       &lt;sequence&gt;
 *         &lt;element name="PdctClssfctn" type="{urn:kdpw:xsd:trar.sts.001.04}ProductClassification1Choice" minOccurs="0"/&gt;
 *         &lt;element name="PdctId" type="{urn:kdpw:xsd:trar.sts.001.04}SecurityIdentification18Choice__1" minOccurs="0"/&gt;
 *         &lt;element name="UndrlygInstrm" type="{urn:kdpw:xsd:trar.sts.001.04}SecurityIdentification19Choice__2" minOccurs="0"/&gt;
 *         &lt;element name="TechUndrlyg" type="{urn:kdpw:xsd:trar.sts.001.04}Max50Text" minOccurs="0"/&gt;
 *         &lt;element name="NtnlCcyFrstLeg" type="{urn:kdpw:xsd:trar.sts.001.04}ActiveCurrencyCode"/&gt;
 *         &lt;element name="NtnlCcyScndLeg" type="{urn:kdpw:xsd:trar.sts.001.04}ActiveCurrencyCode" minOccurs="0"/&gt;
 *         &lt;element name="DlvrblCcy" type="{urn:kdpw:xsd:trar.sts.001.04}ActiveCurrencyCode" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
