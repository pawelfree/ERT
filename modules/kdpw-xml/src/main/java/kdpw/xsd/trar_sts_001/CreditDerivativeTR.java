 ...
 *       &lt;sequence&gt;
 *         &lt;element name="Snrty" type="{urn:kdpw:xsd:trar.sts.001.03}DebtInstrumentSeniorityType2Code"/&gt;
 *         &lt;element name="RefPty" type="{urn:kdpw:xsd:trar.sts.001.03}ReferenceParty" minOccurs="0"/&gt;
 *         &lt;element name="PmtFrqcy" type="{urn:kdpw:xsd:trar.sts.001.03}Frequency8Code"/&gt;
 *         &lt;element name="ClctnBsis" type="{urn:kdpw:xsd:trar.sts.001.03}ESMADayCount"/&gt;
 *         &lt;element name="Srs" type="{urn:kdpw:xsd:trar.sts.001.03}ESMAPositiveInteger5" minOccurs="0"/&gt;
 *         &lt;element name="Vrsn" type="{urn:kdpw:xsd:trar.sts.001.03}ESMAPositiveInteger5" minOccurs="0"/&gt;
 *         &lt;element name="IndxFctr" type="{urn:kdpw:xsd:trar.sts.001.03}PercentageRate" minOccurs="0"/&gt;
 *         &lt;element name="Trch" type="{urn:kdpw:xsd:trar.sts.001.03}TrancheIndicator"/&gt;
 *         &lt;element name="AttchmntPt" type="{urn:kdpw:xsd:trar.sts.001.03}PercentageRate" minOccurs="0"/&gt;
 *         &lt;element name="DtchmntPt" type="{urn:kdpw:xsd:trar.sts.001.03}PercentageRate" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
