 ...
 *       &lt;sequence&gt;
 *         &lt;element name="ClrOblgtn" type="{urn:kdpw:xsd:trar.sts.001.03}YesNoIndicator" minOccurs="0"/&gt;
 *         &lt;element name="Clrd" type="{urn:kdpw:xsd:trar.sts.001.03}YesNoIndicator"/&gt;
 *         &lt;element name="ClrDtTm" type="{urn:kdpw:xsd:trar.sts.001.03}ISONormalisedDateTime" minOccurs="0"/&gt;
 *         &lt;element name="CCP" type="{urn:kdpw:xsd:trar.sts.001.03}LEIIdentifier" minOccurs="0"/&gt;
 *         &lt;element name="IntraGrp" type="{urn:kdpw:xsd:trar.sts.001.03}YesNoIndicator" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class TradeClearingTR {
     ...
     *     
     */
    public void setClrOblgtn(Boolean value) {
