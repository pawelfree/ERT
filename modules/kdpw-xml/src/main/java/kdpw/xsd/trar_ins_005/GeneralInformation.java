 ...
 *       &lt;sequence&gt;
 *         &lt;element name="TRRprtId" type="{urn:kdpw:xsd:trar.ins.005.02}TRInstitutionCode"/&gt;
 *         &lt;element name="SndrMsgRef" type="{urn:kdpw:xsd:trar.ins.005.02}Max16Text"/&gt;
 *         &lt;element name="FuncOfMsg" type="{urn:kdpw:xsd:trar.ins.005.02}FunctionOfMessage"/&gt;
 *         &lt;element name="ActnTp" type="{urn:kdpw:xsd:trar.ins.005.02}Max1Text"/&gt;
 *         &lt;element name="ActnTpDtls" type="{urn:kdpw:xsd:trar.ins.005.02}Max50Text" minOccurs="0"/&gt;
 *         &lt;element name="CreDtTm" type="{urn:kdpw:xsd:trar.ins.005.02}DateAndDateTimeChoice" minOccurs="0"/&gt;
 *         &lt;element name="EligDt" type="{urn:kdpw:xsd:trar.ins.005.02}ISODate"/&gt;
 *         &lt;element name="DtlLvl" type="{urn:kdpw:xsd:trar.ins.005.02}Max1Text"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
