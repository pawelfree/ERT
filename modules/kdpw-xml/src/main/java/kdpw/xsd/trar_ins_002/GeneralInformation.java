 ...
 *       &lt;sequence&gt;
 *         &lt;element name="RptgNtty" type="{urn:kdpw:xsd:trar.ins.002.04}LEIIdentifier" minOccurs="0"/&gt;
 *         &lt;element name="SndrMsgRef" type="{urn:kdpw:xsd:trar.ins.002.04}Max16Text"/&gt;
 *         &lt;element name="EligDt" type="{urn:kdpw:xsd:trar.ins.002.04}ISODate"/&gt;
 *         &lt;element name="DtlsLvl" type="{urn:kdpw:xsd:trar.ins.002.04}Max1Text"/&gt;
 *         &lt;element name="RepTmStmp" type="{urn:kdpw:xsd:trar.ins.002.04}ISONormalisedDateTime"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class GeneralInformation {
    ...
    @XmlElement(name = "DtlsLvl", required = true)
    protected String dtlsLvl;
    ...
    /**
     * Gets the value of the dtlsLvl property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getDtlsLvl() {
        return dtlsLvl;
    }

    /**
     * Sets the value of the dtlsLvl property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setDtlsLvl(String value) {
        this.dtlsLvl = value;
    }
