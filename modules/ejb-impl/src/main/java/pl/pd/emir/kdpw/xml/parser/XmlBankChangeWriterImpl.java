...
@Stateless
@Local(XmlBankChangeWriter.class)
public class XmlBankChangeWriterImpl extends XmlWriterImpl implements XmlBankChangeWriter {
    ...
    @Override
    protected final String getActpTp() {
        return CHANGE_TYPE;
    }
