...
@Stateless
@Local(MultiNumberGenerator.class)
public class MultiNumberGeneratorImpl implements MultiNumberGenerator {

    private static final Logger LOGGER = LoggerFactory.getLogger(MultiNumberGeneratorImpl.class);
    ...
    public MultiNumberGeneratorImpl() {
        super();
    }
    ...
    protected final MultiNumber createMultiNumber(final Date forDate, final MultiGeneratorKey key) {
