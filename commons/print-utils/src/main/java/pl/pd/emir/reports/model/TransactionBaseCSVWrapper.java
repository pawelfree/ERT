...
public class TransactionBaseCSVWrapper {

    final private List<String> header = new ArrayList<>();

    public TransactionBaseCSVWrapper() {
        header.clear();
        addHeader();
    }
    ...
    private void addHeader() {
        header.add("id_TR");
        header.add("DATA_TR");
        header.add("STATUS_TR");
        header.add("ID_KLIENTA");
        header.add("STRONA_TR");
        header.add("POTWIERDZONA");
        header.add("BCTRPTYDTLS_BRKRID_ID");
        header.add("BCTRPTYDTLS_BRKRID_TP");
        header.add("BCTRPTYDTLS_CLRMMBID_ID");
        header.add("BCTRPTYDTLS_CLRMMBID_TP");
        header.add("BCTRPTYDTLS_CLRACCT");
        header.add("BCTRPTYDTLS_BNFCRYID_ID");
        header.add("BCTRPTYDTLS_BNFCRYID_TP");
        header.add("BCTRPTYDTLS_TRDGCPCTY");
        header.add("BCTRPTYDTLS_CMMRCLACTVTY");
        header.add("BCTRPTYDTLS_CLRTRSHLD");
        header.add("BCTRPTYDTLS_COLLPRTF");
        header.add("KCTRPTYDTLS_BRKRID_ID");
        header.add("KCTRPTYDTLS_BRKRID_TP");
        header.add("KCTRPTYDTLS_CLRMMBID_ID");
        header.add("KCTRPTYDTLS_CLRMMBID_TP");
        header.add("KCTRPTYDTLS_CLRACCT");
        header.add("KCTRPTYDTLS_BNFCRYID_ID");
        header.add("KCTRPTYDTLS_BNFCRYID_TP");
        header.add("KCTRPTYDTLS_TRDGCPCTY");
        header.add("KCTRPTYDTLS_CMMRCLACTVTY");
        header.add("KCTRPTYDTLS_CLRTRSHLD");
        header.add("KCTRPTYDTLS_COLLPRTF");
        header.add("TRADID_ID");
        header.add("TRADID_TRADREFNB");
        header.add("CNTRCTTP_TXNM");
        header.add("CNTRCTTP_PRDCTID1");
        header.add("CNTRCTTP_PRDCTID2");
        header.add("CNTRCTTP_UNDRLYG");
        header.add("CNTRCTTP_ISRCTRY");
        header.add("CNTRCTTP_NTNLCCY1");
        header.add("CNTRCTTP_NTNLCCY2");
        header.add("CNTRCTTP_DLVRBLCCY");
        header.add("TRADADDTLINF_VENUEOFEXC");
        header.add("TRADADDTLINF_CMPRSSN");
        header.add("TRADADDTLINF_AMT");
        header.add("TRADADDTLINF_AMT_WAL");
        header.add("TRADADDTLINF_PRCNTG");
        header.add("TRADADDTLINF_NMNLAMT");
        header.add("TRADADDTLINF_PRICMLTPLR");
        header.add("TRADADDTLINF_QTY");
        header.add("TRADADDTLINF_UPPMT");
        header.add("TRADADDTLINF_DLVRYTP");
        header.add("TRADADDTLINF_EXECDTTM");
        header.add("TRADADDTLINF_FCTYDT");
        header.add("TRADADDTLINF_MTRTYDT");
        header.add("TRADADDTLINF_TRMNTNDT");
        header.add("TRADADDTLINF_STTLMTDT");
        header.add("TRADADDTLINF_MSTRAGRMNTTP");
        header.add("TRADADDTLINF_MSTRAGRMNTVRSN");
        header.add("RSKMTGTN_CNFRMTNDTTM");
        header.add("RSKMTGTN_CNFRMTNTP");
        header.add("CLRGINF_CLROBLGTN");
        header.add("CLRGINF_CLRD");
        header.add("CLRGINF_CLRDTTM");
        header.add("CLRGINF_CCP");
        header.add("CLRGINF_INTRGRP");
        header.add("IRTRAD_FXDRATELG1");
        header.add("IRTRAD_FXDRATELG2");
        header.add("IRTRAD_FXDRATEDAYCNT");
        header.add("IRTRAD_FXDLGPMTFRQCY");
        header.add("IRTRAD_FLTGLGPMTFRQCY");
        header.add("IRTRAD_FLTGLGRSTFRQCY");
        header.add("IRTRAD_FLTGRATELG1");
        header.add("IRTRAD_FLTGRATELG2");
        header.add("FXTRAD_CCY2");
        header.add("FXTRAD_XCHGRATE1");
        header.add("FXTRAD_FRWRDXCHGRATE");
        header.add("FXTRAD_XCHGRATEBSIS");
        header.add("CMMDTYTRAD_CMMDTYBASE");
        header.add("CMMDTYTRAD_ CMMDTYDTLS");
        header.add("CMMDTYTRAD_DLVRYPNT");
        header.add("CMMDTYTRAD_INTRCNNCTNPNT");
        header.add("CMMDTYTRAD_LDTP");
        header.add("CMMDTYTRAD_DLVRYSTARTDTTM");
        header.add("CMMDTYTRAD_ DLVRYENDDTTM");
        header.add("CMMDTYTRAD_CNTRCTCPCTY");
        header.add("CMMDTYTRAD_QTY");
        header.add("CMMDTYTRAD_PRIC");
        header.add("OPTNTRAD_OPTNTP");
        header.add("OPTNTRAD_EXRCSTYLE");
        header.add("OPTNTRAD_STRKPRIC");
